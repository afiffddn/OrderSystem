  ...
  <div id="main">
    ...
    <div class="wrapper">
      ...
      <form class="formValidate" id="formValidate" method="post" action="place-order.php" novalidate="novalidate">
        ...
        {
          echo '<tr><td>'.$row["id"].'</td><td>'.$row["customer_id"].'</td><td>RM '.$row["address"].'</td><td>'.$row["description"].'</td><td>'.$row["date"].'</td><td>'.$row["payment_type"].'</td><td>'.$row["total"].'</td><td>'.$row["status"].'</td>';                      
