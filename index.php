    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold active"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Booking Tables</a>
            </li>
                <li class="no-padding">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Harinesvari Café Reservation
System</h5>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              ...
              <div>
                  <table id="data-table-customer" class="responsive-table display" cellspacing="0">
                    ...
                    <tbody>
				<?php
				$result = mysqli_query($con, "SELECT * FROM tables");
				while($row = mysqli_fetch_array($result))
				{
					echo '<tr><td>'.$row["name"].'</td><td>'.$row["capacitypp"].'</td><td>RM '.$row["price"].'</td><td>'.$row["status"].'</td>';                      
			  ...
			  <div>
			  <div class="input-field col s12">
                              <button class="btn cyan waves-effect waves-light right" type="submit" name="action">BOOK NOW
