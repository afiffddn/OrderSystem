    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        ...
        <div class="col col s8 m8 l8">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Booking Tables</a>
            </li>
                <li class="no-padding">
...
<?php
  ...
  {
    if(is_numeric($key)){   
    $result = mysqli_query($con, "SELECT * FROM tables WHERE id = $key");
    while($row = mysqli_fetch_array($result))
    {
      $price = $row['price'];
      $item_name = $row['name'];
...
<button class="btn cyan waves-effect waves-light right" type="submit" name="action" <?php if($_POST['payment_type'] == 'Wallet') {if ($balance-$total < 0) {echo 'disabled'; }}?>>Confirm Booking
